...
const os = require("os");
const { buildCAClient, registerAndEnrollUser, enrollAdmin } = require(os.homedir() + '/ValveChain-Application/fabric_application/test_application/CAUtil.js');
const { buildCCPOrg1, buildWallet } = require(os.homedir() + '/ValveChain-Application/fabric_application/test_application/AppUtil.js');
...
module.exports = ValveChainApplication;
